#title: "Exploratary data analysis for FIFA 2017"
...
topclub_byplayerrating<-head(TeamDF_RFA, 10) # Top 10 
tail(TeamDF_RFA, 10) # Bottom 10 

write.csv(topclub_byplayerrating, file = 'topclub_byplayerrating.csv', row.names = F)

#Let's check, picking an attribute Stamina of player. Which continent player is having good stamina?
...
#What i have done, what can be done
#I have Run this kernal with selective attributes, you can lookin with different attributes
#Which Attribute which player has to develop, i have done for forward players, can be done with Midfielder, Defender , Goalkeeper data frames created.
